                  ...
                  <form className="flex flex-col gap-3">
                    <div className="w-full flex flex-col gap-2">
                      ...
                      <input
                        ...
                        className="w-full border border-gray-400 px-3 py-2 rounded-lg focus:outline-none focus:border-main-300"
                      />
                    </div>
                    <div className="w-full flex flex-col gap-2">
                    ...
                    <div
                      onClick={submit}
                      className="w-full text-center bg-main-300 text-white py-2 rounded-lg"
                    >
                      Sign Up
                    </div>
                  </form>
